...
internal sealed class GuidSequences
{
    ...
    public GuidSequences(Guid g) : this(g, isUpper: false) { }
    ...
    private GuidSequences AsLower() => new GuidSequences(this.g, isUpper: false);

    private GuidSequences AsUpper() => new GuidSequences(this.g, isUpper: true);
